  ...
  return (
    <div className="auth-split-layout">
          ...
          <div className="mock-window-body" style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <div className="mock-item-row" style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', paddingBottom: 'none', borderBottom: 'none' }}>
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                <span style={{ fontSize: '10px', color: 'var(--text-secondary)' }}>Space: <code style={{ color: 'var(--danger)' }}>O(N)</code></span>
                <span style={{ fontSize: '10px', color: 'var(--primary)', fontWeight: '700' }}>Optimised Space: <code>O(1)</code></span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="auth-split-right-form">
        <div className="auth-split-focused-area" style={{ maxWidth: '420px' }}>
          ...
          <form onSubmit={handleSubmit} className="auth-form" style={{ marginTop: '14px' }} noValidate>
            <div className="form-group-row" style={{ gap: '12px' }}>
              <div className="form-group">
                ...
                {validationErrors.fullName && (
                  <span className="field-error-text" aria-live="polite" style={{ fontSize: '12px' }}>
                    {validationErrors.fullName}
                  </span>
                )}
              </div>
